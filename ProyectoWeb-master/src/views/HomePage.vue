        ...
        <form @submit.prevent="login" class="login-form">
          ...
          <div class="form-group">
            <ion-item class="custom-item">
              ...
              <ion-input v-model="credentials.email" type="text" required class="custom-input"></ion-input>
            </ion-item>
          </div>
...
// Ejecutar verificación de sesión cuando el componente se monte
onMounted(() => {
    ...
    if (error.response) {
      switch (error.response.status) {
        case 401:
          ...
          break;
        case 403:
          errorMessage.value = 'Cuenta bloqueada. Contacta con soporte';
          break;
        case 429:
          errorMessage.value = 'Demasiados intentos. Inténtalo más tarde';
          break;
        case 500:
